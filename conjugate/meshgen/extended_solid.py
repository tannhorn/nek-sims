...
# -----------------------------------------------------------------------------
inlet_tags = [l1]
inlet_group = gmsh.model.addPhysicalGroup(1, inlet_tags, 15)
...
left_side_group = gmsh.model.addPhysicalGroup(1, [left_side], 16)
gmsh.model.setPhysicalName(1, left_side_group, "BottomSolid")

right_side_group = gmsh.model.addPhysicalGroup(1, [right_side], 17)
...
outlet_group = gmsh.model.addPhysicalGroup(1, list(outlet_tags), 18)
